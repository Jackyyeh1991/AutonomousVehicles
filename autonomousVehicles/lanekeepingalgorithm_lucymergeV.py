...
def go_faster():
    ...
    throttle(go_forward + go_faster_addition)
...
def get_steering_angle(frame, lane_lines):
    ...
    print("steering angel：%d " % steering_angle)
...
def checkifStopsign(image):
    ...
    for i in indices:
        ...
        indexx = class_ids[int(i)]
        if classes[indexx] == "stop sign":
            return True
    return False
...
while counter < max_ticks:
    ...
    # CYY ---------------------- start
    print(checkifStopsign(frame))
    # TODO if (checkifStopsign(frame)):
    #     stop the car
    # CYY -----------------------end 
